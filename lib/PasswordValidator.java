...
public class PasswordValidator {
     ...
     * -------------------------------------
     * WEAK
     * ถ้า password มีแค่ตัวอักษรตัวเล็ก จะเป็น Weak
     * ถ้า password มีแค่ตัวอักษรตัวตัวใหญ่ จะเป็น Weak
     * ถ้า password มีแค่ตัวเลข จะเป็น Weak
     * ถ้า password มีแค่ตัวอักขระ จะเป็น Weak
     * -------------------------------------
     * MEDIUM
     * ถ้า password มีตัวอักษรตัวเล็กและตัวเลข จะเป็น Medium
     * ถ้า password มีคัวอักษรตัวใหญ่และตัวเลข จะเป็น Medium
     * ถ้า password มีคัวอักษรตัวอักขระและตัวเลข จะเป็น Medium
     * -------------------------------------
     * STRONG
     * ถ้า password มีตัวอักษรทั้งตัวเล็กและตัวใหญ่และตัวเลข Strong
     * ถ้า password มีตัวอักษรทั้งตัวเล็กและตัวใหญ่และอักขระและตัวเลข Strong
     * -------------------------------------
